...
using MyProtocolsAPI_CristianSalazar.ModelsDTOs;
...
namespace MyProtocolsAPI_CristianSalazar.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(MyProtocolDBContext context)
        {
            _context = context;
        }
        ...
        {
            //acá creamos un linq que combina informacion de dops entidades
            //(user inner userrole) y la agrega en el objeto DTO de Usuario
        ...
        public async Task<IActionResult> PutUser(int id, UserDTO user)
        {
            ...
            //tenemos que hacer la conversion entre el DTO que llega en formato
            //json(en el header) y el objeto que entity framework entiende
            //que es de tipo user
        ...
        public async Task<ActionResult<User>> PostUser(User user)
        {
          if (_context.Users == null)
          {
              return Problem("Entity set 'MyProtocolDBContext.Users'  is null.");
          }
