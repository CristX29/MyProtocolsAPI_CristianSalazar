...
namespace MyProtocolsAPI_CristianSalazar.Models
{
    public partial class MyProtocolDBContext : DbContext
    {
        public MyProtocolDBContext()
        {
        }

        public MyProtocolDBContext(DbContextOptions<MyProtocolDBContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                //optionsBuilder.UseSqlServer("SERVER=DESKTOP-A0CTDNO\\SQLEXPRESS; DATABASE= MyProtocolDB; INTEGRATED SECURITY=FALSE; USER ID= MyProtocolsAPIUser; PASSWORD=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Protocol>(entity =>
            {
                ...
                entity.HasMany(d => d.ProtocolStepProtocolSteps)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("ProtocolProtocolId", "ProtocolStepProtocolStepsId").HasName("PK__Protocol__7C26129550005AF4");
            ...
            modelBuilder.Entity<ProtocolCategory>(entity =>
            {
                entity.HasKey(e => e.ProtocolCategory1)
                    .HasName("PK__Protocol__0ED5AEE58646116A");
            ...
            modelBuilder.Entity<ProtocolStep>(entity =>
            {
                entity.HasKey(e => e.ProtocolStepsId)
                    .HasName("PK__Protocol__C75F186E2761DA18");
